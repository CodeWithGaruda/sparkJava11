package com.rayala.chapter13_rddjoins;
...
public class RDDJoinsTest {
    ...
    void testInnerJoinInSparkRDD() {
        JavaPairRDD<Integer, Tuple2<String, Double>> innerJoinRdd = customersPairs.join(billsPairs);
    ...
    void testLeftOuterJoinInSparkRDD() {
        JavaPairRDD<Integer, Tuple2<String, Optional<Double>>> leftOuterJoinRdd = customersPairs.leftOuterJoin(billsPairs);
    ...
    void testRightOuterJoinInSparkRDD() {
        JavaPairRDD<Integer, Tuple2<Optional<String>, Double>> rightOuterJoinRdd = customersPairs.rightOuterJoin(billsPairs);
    ...
    void testFullOuterJoinInSparkRDD() {
        JavaPairRDD<Integer, Tuple2<Optional<String>, Optional<Double>>> fullOuterJoinRdd = customersPairs.fullOuterJoin(billsPairs);

...
public class RDDClosuresAccumulatorsTest {
    ...
    void testStringAccumulatorInSparkRDD() {
        try (final var sparkContext = new JavaSparkContext(sparkConf)) {
            ...
            final var data = List.of("Java", "Python", "JavaScript", "C++", "SQL");
            final var myRdd = sparkContext.parallelize(data);
    ...
    void testStockPositionAccumulatorInSparkRDD() {
        try (final var sparkContext = new JavaSparkContext(sparkConf)) {
            ...
            final var trades1 = List.of(trade1, trade2, trade3);
            final var trades2 = List.of(trade4, trade5, trade6);
    ...
    void mergeTwoMaps() {
        ...
        stockPosition1.forEach((stock, position) -> System.out.printf("Stock %s has total %f position%n", stock, position));
    }
}
